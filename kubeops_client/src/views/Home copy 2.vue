    ...
    <div class="config-panel" v-show="toggle">
      <div>
        <div class="item">
          ...
          <el-select class="value" v-model="modePath" @change="handleModelPathChange" value-key="name">
        ...
        <div class="item">
          ...
          <el-select class="value" v-model="wrap" @change="handleWrapChange" value-key="name">
